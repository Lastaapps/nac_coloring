...
Variable naming may not correspond to the naming convention in the paper,
still the code is self-explanatory and documented.
...
### NAC-critical Globally rigid graphs
